...
declare const _default: ({ itemWidth, itemHeight, sectionWidth, sectionHeight, numColumns, index, itemLength, isEditing, animMoveDuration, scrollThreshold, shouldAnimOnRelease, listRef, listLayoutRef, listContentHeightRef, listOffsetYRef, multiplierRTL, startAnim, endAnim, onStartDrag, updateDragToIndex, onEndDrag }: {
    itemWidth: number;
    itemHeight: number;
    sectionWidth: number;
